...
--%>
<%@ page import=" org.mindinformatics.ann.framework.module.security.utils.UserStatus" %>
			...
			<tbody>
				...
				<tr class="prop">
					...
					<td valign="top" class="value" colspan="2">
						<div>
							<g:if test="${UserUtils.getStatusLabel(item)==UserStatus.CREATED_USER.value()}">
							...
							<g:elseif test="${UserUtils.getStatusLabel(item)==UserStatus.ACTIVE_USER.value()}">
							...
							<g:elseif test="${UserUtils.getStatusLabel(item)==UserStatus.LOCKED_USER.value()}">
