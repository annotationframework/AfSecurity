...
<div class="sectioncontainer">
	<div class="dialog" style="width: 660px">
		<fieldset>
			...
			<div>
				<span class="button">
					<g:link class="edit"  controller="dashboard" action="manageUsersOfSystem" id="${item.id}" style="text-decoration: none;">
						<img src="${resource(dir: 'images/dashboard', file: 'edit_group.png')}" alt="Manage Groups" style="display: inline" />Manage System Users
					</g:link>
					&nbsp;
					<span class="button">
						<g:link controller="dashboard" action="addUsersToSystem" id="${item.id}" style="text-decoration: none;">
