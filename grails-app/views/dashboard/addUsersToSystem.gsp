...
<html>
  <head>
	...
	<title>Add Users to System: ${system.name} :: ${grailsApplication.config.af.shared.title}</title>
	...
	<body>
		 <div class="title">
			<img style="display: inline; vertical-align: middle;" src="${resource(dir:'images/dashboard',file:'search.png')}"/> Add Users to System: ${system.name}
		</div>
		<g:render template="addUsersToSystem" />
	</body>
</html>